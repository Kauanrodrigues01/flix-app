...
def show_movies():
    ...
    if movies:
        ...
        columns_to_drop = ['actors', 'genre.id']
        existing_columns = [col for col in columns_to_drop if col in movies_df.columns]
        
        if existing_columns:
            movies_df = movies_df.drop(columns=existing_columns)
